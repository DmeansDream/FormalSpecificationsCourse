...
namespace _module {
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      _nw0.__ctor(_module.State.create_Boot(), new Dafny.BigRational(BigInteger.Parse("20"), BigInteger.One));
      _0_turnstile = _nw0;
      RiderPass _1_pass;
    ...
    public static BigInteger PersonTick { get {
  ...
  public interface _IState {
    ...
    bool is_Closed { get; }
    bool is_Open { get; }
    bool is_Processing { get; }
    _IState DowncastClone();
  }
  public abstract class State : _IState {
    public State() {
    }
    private static readonly _IState theDefault = create_Boot();
    ...
    public static _IState create_Boot() {
      return new State_Boot();
    }
    public static _IState create_Closed() {
      return new State_Closed();
    }
    public static _IState create_Open() {
      return new State_Open();
    }
    public static _IState create_Processing() {
      return new State_Processing();
    }
    public bool is_Boot { get { return this is State_Boot; } }
    public bool is_Closed { get { return this is State_Closed; } }
    public bool is_Open { get { return this is State_Open; } }
    public bool is_Processing { get { return this is State_Processing; } }
    public static System.Collections.Generic.IEnumerable<_IState> AllSingletonConstructors {
      get {
        yield return State.create_Boot();
        yield return State.create_Closed();
        yield return State.create_Open();
        yield return State.create_Processing();
      }
    }
    public abstract _IState DowncastClone();
  }
  public class State_Boot : State {
    public State_Boot() : base() {
    }
    public override _IState DowncastClone() {
      if (this is _IState dt) { return dt; }
      return new State_Boot();
    }
    public override bool Equals(object other) {
      var oth = other as State_Boot;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public class State_Closed : State {
    public State_Closed() : base() {
    }
    public override _IState DowncastClone() {
      if (this is _IState dt) { return dt; }
      return new State_Closed();
    ...
    public override string ToString() {
      string s = "State.Closed";
      return s;
    }
  }
  public class State_Open : State {
    public State_Open() : base() {
    }
    public override _IState DowncastClone() {
      if (this is _IState dt) { return dt; }
      return new State_Open();
  ...
  public class State_Processing : State {
    public State_Processing() : base() {
    }
    public override _IState DowncastClone() {
      if (this is _IState dt) { return dt; }
      return new State_Processing();
    ...
    public override bool Equals(object other) {
      var oth = other as State_Processing;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public partial class Turnstile {
    public Turnstile() {
      ...
      this.gate = false;
      this.bill = Dafny.BigRational.ZERO;
      this.timerTicks = BigInteger.Zero;
      this.personPassed = false;
    }
    public _IState state {get; set;}
    ...
    public bool ProcessNFCSource(NFCSource source)
    {
      bool res = false;
      if (Dafny.Helpers.Let<NFCSource, bool>(source, _is_0 => _is_0 is RiderPass)) {
        RiderPass _0_pass;
        _0_pass = ((RiderPass)(source));
        BigInteger _1_ID;
        _1_ID = (_0_pass).Read();
        (this).state = _module.State.create_Processing();
        if (((_1_ID).Sign == -1) || (!((this).HasKDigits(_1_ID, new BigInteger(8))))) {
          (this).state = _module.State.create_Closed();
          res = false;
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error in ID")).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
          return res;
        }
        BigInteger _2_passRides;
        _2_passRides = (_0_pass).GetRides();
        if ((_2_passRides).Sign != 1) {
          (this).state = _module.State.create_Closed();
          res = false;
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Low On Rides")).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
          return res;
        }
        (_0_pass).ConsumeRide();
        (this).state = _module.State.create_Closed();
        (this).DoorCycle(__default.tickCount, __default.PersonTick);
        res = true;
        return res;
      } else if (Dafny.Helpers.Let<NFCSource, bool>(source, _is_1 => _is_1 is PaymentCard)) {
        PaymentCard _3_card;
        _3_card = ((PaymentCard)(source));
        BigInteger _4_ID;
        _4_ID = (_3_card).Read();
        (this).state = _module.State.create_Processing();
        if (((_4_ID).Sign == -1) || (!((this).HasKDigits(_4_ID, new BigInteger(16))))) {
          (this).state = _module.State.create_Closed();
          res = false;
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Error in ID")).ToVerbatimString(false));
          Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    ...
    public void DoorCycle(BigInteger ticks, BigInteger personAtTick)
    {
      (this).OpenTurner(ticks);
      BigInteger _0_i;
      _0_i = BigInteger.Zero;
      while (((_0_i) < (ticks)) && (object.Equals(this.state, _module.State.create_Open()))) {
        if (((_0_i) == (personAtTick)) && ((personAtTick).Sign == 1)) {
          (this).PersonPassed();
        } else {
          (this).Tick();
        }
      ...
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Turner closed at: ")).ToVerbatimString(false));
      Dafny.Helpers.Print(((_0_i) - (BigInteger.One)));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
    public void OpenTurner(BigInteger ticks)
    {
      (this).state = _module.State.create_Open();
      (this).gate = true;
      (this).timerTicks = ticks;
      (this).personPassed = false;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Turner opened")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
    public void PersonPassed()
    {
      (this).state = _module.State.create_Closed();
      (this).gate = false;
      (this).timerTicks = BigInteger.Zero;
      (this).personPassed = true;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Person passed")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
    public void Tick()
    {
      (this).timerTicks = (this.timerTicks) - (BigInteger.One);
      if ((this.timerTicks).Sign == 0) {
        (this).state = _module.State.create_Closed();
        (this).gate = false;
      }
    }
  ...
  public class _Companion_BaseValidation {
  }
  ...
  public interface Pass : BaseValidation {
    BigInteger rides { get; set; }
    BigInteger GetRides();
    void ConsumeRide();
  }
  public class _Companion_Pass {
    public static BigInteger GetRides(Pass _this) {
      return _this.rides;
    }
  }

  public interface Deductable : BaseValidation {
    Dafny.BigRational balance { get; set; }
    Dafny.BigRational GetBal();
    void Deduct(Dafny.BigRational bill);
  }
  public class _Companion_Deductable {
    public static Dafny.BigRational GetBal(Deductable _this) {
      return _this.balance;
    }
  }

  public partial class RiderPass : NFCSource, Pass, BaseValidation {
    public RiderPass() {
      this._rides = BigInteger.Zero;
      this._ID = BigInteger.Zero;
    }
    public BigInteger GetRides() {
      return _Companion_Pass.GetRides(this);
    }
    public BigInteger _rides {get; set;}
    public BigInteger rides {
      get {
        return this._rides;
      }
      set {
  ...
  public partial class PaymentCard : NFCSource, Deductable, BaseValidation {
    public PaymentCard() {
      this._balance = Dafny.BigRational.ZERO;
      this._ID = BigInteger.Zero;
    }
    public Dafny.BigRational _balance {get; set;}
    public Dafny.BigRational balance {
      get {
    ...
    public void Deduct(Dafny.BigRational bill)
    {
