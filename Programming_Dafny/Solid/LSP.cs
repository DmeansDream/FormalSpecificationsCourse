// Dafny program LSP.dfy compiled into C#
...
// Command-line arguments: run --verification-time-limit 360 LSP.dfy
// LSP.dfy
...
function RankToFace(rank: int): FaceRank
  requires 11 <= rank <= 13
  ensures match rank case 11 => RankToFace(rank) == Jack case 12 => RankToFace(rank) == Queen case 13 => RankToFace(rank) == King
  decreases rank
{
  match rank
  case 11 =>
...
method SumOfHand(cards: seq<Card>) returns (sum: int)
  requires 0 < |cards|
  requires forall k: int {:trigger cards[k]} :: 0 <= k < |cards| ==> cards[k].Valid() == true
  ensures |cards| <= sum
  decreases cards
{
  sum := 0;
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger FaceRankToInt(_IFaceRank f) {
      _IFaceRank _source0 = f;
      {
        if (_source0.is_Jack) {
    ...
    public static _IFaceRank RankToFace(BigInteger rank) {
      BigInteger _source0 = rank;
      {
        if ((_source0) == (new BigInteger(11))) {
          return _module.FaceRank.create_Jack();
        }
      }
      {
        if ((_source0) == (new BigInteger(12))) {
          return _module.FaceRank.create_Queen();
        }
      }
      {
        return _module.FaceRank.create_King();
      }
    }
    public static BigInteger SumOfHand(Dafny.ISequence<Card> cards)
    {
      BigInteger sum = BigInteger.Zero;
      sum = BigInteger.Zero;
      BigInteger _0_i;
      _0_i = BigInteger.Zero;
      while ((_0_i) < (new BigInteger((cards).Count))) {
        BigInteger _1_v;
        _1_v = ((cards).Select(_0_i)).Value();
        sum = (sum) + (_1_v);
    ...
    {
      Dafny.ISequence<Card> _0_hand;
      _0_hand = Dafny.Sequence<Card>.FromElements();
      NumberCard _1_card1;
      NumberCard _nw0 = new NumberCard();
      _nw0.__ctor(new BigInteger(2));
      _1_card1 = _nw0;
      NumberCard _2_card2;
      NumberCard _nw1 = new NumberCard();
      _nw1.__ctor(new BigInteger(8));
      _2_card2 = _nw1;
      FaceCard _3_card3;
      FaceCard _nw2 = new FaceCard();
      _nw2.__ctor(new BigInteger(12));
      _3_card3 = _nw2;
      NumberCard _4_card4;
      NumberCard _nw3 = new NumberCard();
      _nw3.__ctor(new BigInteger(5));
      _4_card4 = _nw3;
      NumberCard _5_card5;
      NumberCard _nw4 = new NumberCard();
      _nw4.__ctor(new BigInteger(14));
      _5_card5 = _nw4;
      _0_hand = Dafny.Sequence<Card>.Concat(_0_hand, Dafny.Sequence<NumberCard>.FromElements(_1_card1));
      _0_hand = Dafny.Sequence<Card>.Concat(_0_hand, Dafny.Sequence<NumberCard>.FromElements(_2_card2));
      _0_hand = Dafny.Sequence<Card>.Concat(_0_hand, Dafny.Sequence<FaceCard>.FromElements(_3_card3));
      _0_hand = Dafny.Sequence<Card>.Concat(_0_hand, Dafny.Sequence<NumberCard>.FromElements(_4_card4));
      _0_hand = Dafny.Sequence<Card>.Concat(_0_hand, Dafny.Sequence<NumberCard>.FromElements(_5_card5));
      BigInteger _6_result;
      BigInteger _out0;
      _out0 = __default.SumOfHand(_0_hand);
      _6_result = _out0;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Sum of hand result: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_6_result));
  ...
  public class _Companion_Card {
  }

  public partial class NumberCard : Card {
    public NumberCard() {
      this._rank = BigInteger.Zero;
    }
    public void __ctor(BigInteger num)
    {
      (this)._rank = num;
    }
    ...
    public BigInteger _rank {get; set;}
    public BigInteger rank { get {
      return this._rank;
    } }
  }

  public partial class FaceCard : Card {
    public FaceCard() {
      this._rank = BigInteger.Zero;
      this._face = FaceRank.Default();
    }
    public void __ctor(BigInteger num)
    {
      (this)._rank = num;
      (this)._face = __default.RankToFace(num);
    }
    public BigInteger Value() {
      return (this).rank;
    }
    ...
    public _IFaceRank _face {get; set;}
    public _IFaceRank face { get {
      return this._face;
    } }
  }

  public interface _IFaceRank {
    bool is_Jack { get; }
    bool is_Queen { get; }
    bool is_King { get; }
    _IFaceRank DowncastClone();
  }
  public abstract class FaceRank : _IFaceRank {
    public FaceRank() {
    }
    private static readonly _IFaceRank theDefault = create_Jack();
    public static _IFaceRank Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_IFaceRank> _TYPE = new Dafny.TypeDescriptor<_IFaceRank>(FaceRank.Default());
    public static Dafny.TypeDescriptor<_IFaceRank> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IFaceRank create_Jack() {
      return new FaceRank_Jack();
    }
    public static _IFaceRank create_Queen() {
      return new FaceRank_Queen();
    }
    public static _IFaceRank create_King() {
      return new FaceRank_King();
    }
    public bool is_Jack { get { return this is FaceRank_Jack; } }
    public bool is_Queen { get { return this is FaceRank_Queen; } }
    public bool is_King { get { return this is FaceRank_King; } }
    public static System.Collections.Generic.IEnumerable<_IFaceRank> AllSingletonConstructors {
      get {
        yield return FaceRank.create_Jack();
        yield return FaceRank.create_Queen();
        yield return FaceRank.create_King();
      }
    }
    public abstract _IFaceRank DowncastClone();
  }
  public class FaceRank_Jack : FaceRank {
    public FaceRank_Jack() : base() {
    }
    public override _IFaceRank DowncastClone() {
      if (this is _IFaceRank dt) { return dt; }
      return new FaceRank_Jack();
    }
    public override bool Equals(object other) {
      var oth = other as FaceRank_Jack;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "FaceRank.Jack";
      return s;
    }
  }
  public class FaceRank_Queen : FaceRank {
    public FaceRank_Queen() : base() {
    }
    public override _IFaceRank DowncastClone() {
      if (this is _IFaceRank dt) { return dt; }
      return new FaceRank_Queen();
    ...
    public override bool Equals(object other) {
      var oth = other as FaceRank_Queen;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "FaceRank.Queen";
      return s;
    }
  }
  public class FaceRank_King : FaceRank {
    public FaceRank_King() : base() {
    }
    public override _IFaceRank DowncastClone() {
      if (this is _IFaceRank dt) { return dt; }
      return new FaceRank_King();
    ...
    public override bool Equals(object other) {
      var oth = other as FaceRank_King;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
