// Dafny program OpenClosed.dfy compiled into C#
...
// Command-line arguments: run --verification-time-limit 360 OpenClosed.dfy
// OpenClosed.dfy

method Process(obj: PaymentProcessor, amount: real)
  decreases obj, amount
{
...
namespace _module {
  ...
  public partial class __default {
    public static void Process(PaymentProcessor obj, Dafny.BigRational amount)
    {
      bool _0_result;
      bool _out0;
      _out0 = (obj).ProcessPayment(amount);
      _0_result = _out0;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Result was: ")).ToVerbatimString(false));
    ...
    {
      DefaultImplementation _0_df;
      DefaultImplementation _nw0 = new DefaultImplementation();
      _0_df = _nw0;
      CreditCardProcessor _1_card;
      CreditCardProcessor _nw1 = new CreditCardProcessor();
      _1_card = _nw1;
      VenmoProcessor _2_venmo;
      VenmoProcessor _nw2 = new VenmoProcessor();
      _2_venmo = _nw2;
      __default.Process(_0_df, new Dafny.BigRational(BigInteger.Parse("10"), BigInteger.One));
      __default.Process(_1_card, new Dafny.BigRational(BigInteger.Parse("15"), BigInteger.One));
      __default.Process(_2_venmo, new Dafny.BigRational(new BigInteger(99), BigInteger.Parse("100")));
    }
  }

  public interface PaymentProcessor {
    bool ProcessPayment(Dafny.BigRational amount);
  }
  public class _Companion_PaymentProcessor {
    public static bool ProcessPayment(PaymentProcessor _this, Dafny.BigRational amount)
    {
      bool result = false;
      Dafny.Helpers.Print((amount));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" got default processed ")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      result = true;
      return result;
    }
  ...
  public partial class DefaultImplementation : PaymentProcessor {
    public DefaultImplementation() {
    }
    public bool ProcessPayment(Dafny.BigRational amount)
    {
      bool _out0;
      _out0 = _Companion_PaymentProcessor.ProcessPayment(this, amount);
      return _out0;
    }
  }

  public partial class CreditCardProcessor : PaymentProcessor {
    ...
    public bool ProcessPayment(Dafny.BigRational amount)
    {
      bool result = false;
      Dafny.Helpers.Print((amount));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" on credit card got processed ")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      result = true;
      return result;
    }
  ...
  public partial class VenmoProcessor : PaymentProcessor {
    public VenmoProcessor() {
    }
    public bool ProcessPayment(Dafny.BigRational amount)
    {
      bool result = false;
      Dafny.Helpers.Print((amount));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString(" on Venmo got processed ")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      result = true;
      return result;
    }
