// Dafny program IntSeg_DIP.dfy compiled into C#
...
// Command-line arguments: run --verification-time-limit 360 IntSeg_DIP.dfy
// IntSeg_DIP.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      FlatFeePolicy _0_flat;
      FlatFeePolicy _nw0 = new FlatFeePolicy();
      _nw0.__ctor(new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10")));
      _0_flat = _nw0;
      CardService _1_service1;
      CardService _nw1 = new CardService();
      _nw1.__ctor(_0_flat);
      _1_service1 = _nw1;
      Dafny.BigRational _2_remaining;
      Dafny.BigRational _3_fee;
      ...
      PercentageFeePolicy _4_perc;
      PercentageFeePolicy _nw2 = new PercentageFeePolicy();
      _nw2.__ctor(new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10")));
      _4_perc = _nw2;
      CardService _5_service2;
      CardService _nw3 = new CardService();
      _nw3.__ctor(_4_perc);
      _5_service2 = _nw3;
      Dafny.BigRational _6_remaining2;
      Dafny.BigRational _7_fee2;
      Dafny.BigRational _out2;
      Dafny.BigRational _out3;
  ...
  public interface ServicePolicy {
    Dafny.BigRational ComputeServiceCost(Dafny.BigRational amount);
  }
  public class _Companion_ServicePolicy {
  }

  public partial class FlatFeePolicy : ServicePolicy {
    public FlatFeePolicy() {
      this._flatFee = Dafny.BigRational.ZERO;
    }
    public void __ctor(Dafny.BigRational f)
    {
      (this)._flatFee = f;
    }
    public Dafny.BigRational ComputeServiceCost(Dafny.BigRational amount)
    {
      Dafny.BigRational fee = Dafny.BigRational.ZERO;
      if (((this).flatFee) <= (amount)) {
        fee = (this).flatFee;
      } else {
        fee = amount;
      }
    ...
    public Dafny.BigRational _flatFee {get; set;}
    public Dafny.BigRational flatFee { get {
      return this._flatFee;
    } }
  }

  public partial class PercentageFeePolicy : ServicePolicy {
    public PercentageFeePolicy() {
      this._percentageFee = Dafny.BigRational.ZERO;
    }
    public void __ctor(Dafny.BigRational f)
    {
      (this)._percentageFee = f;
    }
    public Dafny.BigRational ComputeServiceCost(Dafny.BigRational amount)
    {
      Dafny.BigRational fee = Dafny.BigRational.ZERO;
      Dafny.BigRational _0_ratio;
      _0_ratio = ((this).percentageFee) / (new Dafny.BigRational(BigInteger.Parse("100"), BigInteger.One));
      fee = (amount) * (_0_ratio);
      return fee;
    }
    public Dafny.BigRational _percentageFee {get; set;}
    public Dafny.BigRational percentageFee { get {
  ...
  public partial class CardService {
    public CardService() {
      this._feePolicy = ((ServicePolicy)null);
    }
    public void __ctor(ServicePolicy policy)
    {
      (this)._feePolicy = policy;
    }
    public void ProcessPayment(Dafny.BigRational amount, out Dafny.BigRational netAmount, out Dafny.BigRational fee)
    {
      netAmount = Dafny.BigRational.ZERO;
      fee = Dafny.BigRational.ZERO;
      Dafny.BigRational _out0;
      _out0 = ((this).feePolicy).ComputeServiceCost(amount);
      fee = _out0;
      netAmount = (amount) - (fee);
    }
    public ServicePolicy _feePolicy {get; set;}
    public ServicePolicy feePolicy { get {
      return this._feePolicy;
    } }
  }
